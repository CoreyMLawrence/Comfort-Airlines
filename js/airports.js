...
// Function to parse CSV data, sort alphabetically by city name, and store it in session storage
function parseCSVAndStore(csvData) {
  ...
  // Sort airports array alphabetically by city name
...
readFile()
  ...
  .then(() => {
    console.log(
      'CSV data parsed, sorted alphabetically by city name, stored, and top flights displayed successfully.'
    );
  })
